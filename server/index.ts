...
import { connectToDatabase, isConnected } from "./db/mongodb";
...
(async () => {
  try {
    ...
    // Set MongoDB as the storage implementation
    setStorageImplementation(mongoStorage);
    log('Using MongoDB storage implementation');
