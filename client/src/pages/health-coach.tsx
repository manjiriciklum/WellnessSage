...
import { Loader2, Heart, ArrowLeft, MessageSquareText } from 'lucide-react';
                ...
                <CardContent className="p-5">
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>For symptom analysis, use the Symptom Analysis tab</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="rounded-full bg-green-100 p-1 mt-0.5">
                        <div className="w-1.5 h-1.5 rounded-full bg-green-500"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <Card className="shadow-sm">
                <CardContent className="p-5">
                  <div className="flex items-center gap-2 mb-4">
                    <Heart size={18} className="text-neutral-500" />
                    <h3 className="font-medium">Analysis Tips</h3>
                  </div>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <div className="rounded-full bg-green-100 p-1 mt-0.5">
              ...
              <div className="mt-6 col-span-1 md:col-span-3">
